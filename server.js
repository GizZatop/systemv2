...
const youtube = new YouTube("AIzaSyAhNkLo-3-FWIUPBN4rPjG-q-bMuwFi13I"); //تعديل اساسي سوي اي بي اي جديد
const hastebins = require("hastebin-gen");
const getYoutubeID = require("get-youtube-id");
const yt_api_key = "AIzaSyAhNkLo-3-FWIUPBN4rPjG-q-bMuwFi13I"; ///تعديل اساسي سوي اي بي اي جديد
...
client.on("message", message => {
  if (message.content === prefix + "bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@364805775870132225>`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .setImage("")
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "setby")) {
    ...
    client.on("guildMemberAdd", member => {
      ...
      var channel = member.guild.channels.find(gg => gg.name === "👑-𝙎𝙀𝙏𝙏𝙄𝙉𝙂𝙎-👑"); //// تعديل اساسي
      if (!channel) return;
                                ...
                                .then(m4 => {
                                  ...
                                  message.channel
                                    ...
                                    .then(m => {
                                      m.edit(
                                        message.member +
                                          ", **لماذا يجب علينا ان نقبلك ؟ وما هي الرتبه العوزها 🤔**"
                                      );
                                      m.channel
                                        .awaitMessages(
                                          m1 => m1.author == message.author,
